...
export const ProductSkeleton = () => {
  return (
    <div className="relative hover-tilt overflow-hidden">
      <div className="bg-zinc-100 dark:bg-zinc-800/30 rounded-[2rem] mb-4 aspect-[4/5] relative flex items-center justify-center p-4">
...
export const OrderSkeleton = () => {
  return (
    <div className="bg-white dark:bg-[#121212] rounded-[24px] border border-zinc-100 dark:border-zinc-800/80 p-6 flex flex-col xl:flex-row gap-8 mb-4">
