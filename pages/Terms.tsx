  ...
  return (
    <div className="p-6 md:p-12 pb-24 animate-fade-in bg-zinc-50 dark:bg-zinc-800 max-w-4xl mx-auto min-h-screen">
       ...
       <div className="flex items-center space-x-6 mb-12">
          ...
          <h1 className="text-lg md:text-xl font-semibold tracking-tight uppercase">Terms & Conditions</h1>
       </div>

       <div className="space-y-8 text-sm md:text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
          <section>
             <h2 className="text-black dark:text-white font-semibold text-xl mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
             <h2 className="text-black dark:text-white font-semibold text-xl mb-4">2. Returns & Refunds Policy</h2>
          ...
          <section>
             <h2 className="text-black dark:text-white font-semibold text-xl mb-4">3. Warranty Information</h2>
          ...
          <section>
             <h2 className="text-black dark:text-white font-semibold text-xl mb-4">4. Account Security</h2>
