...
const TrackOrder: React.FC = () => {
  ...
  if (loading) return (
    <div className="max-w-[1440px] mx-auto px-6 py-12 md:p-12 pb-40 animate-fade-in min-h-screen bg-zinc-50 dark:bg-zinc-800 flex justify-center">
      <div className="w-full max-w-2xl bg-white dark:bg-zinc-800 rounded-[2rem] p-8 border border-zinc-100 dark:border-zinc-800">
         ...
         <div className="space-y-4 mb-12">
            <div className="w-full h-16 rounded-xl bg-zinc-200 dark:bg-zinc-700 animate-pulse"></div>
            <div className="w-full h-16 rounded-xl bg-zinc-200 dark:bg-zinc-700 animate-pulse"></div>
            <div className="w-full h-16 rounded-xl bg-zinc-200 dark:bg-zinc-700 animate-pulse"></div>
         </div>
      </div>
